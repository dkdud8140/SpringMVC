		...
		<form method="POST">
			<fieldset>
				...
				<div class="btn_box">
					...
					<button type="reset" class="btn_book_new">새로작성</button>
					<button type="button" class="btn_book_list">List</button>
				</div>
...
document.querySelector("button.btn_book_list").addEventListener("click",()=>{
