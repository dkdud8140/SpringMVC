 ...
 * 약속된 데이터를 Response하는 service
 * 
 * 절대 view를 리턴하지 않는다
 * return되는 type으로 데이터를 response 한다
...
public class ApiController {
	 ...
	 * 
	 * JSON 문자열을 JSON, 객체 형식으로 변환(parsing)해야하는 문제에 봉착한다
	 * 
	 * Spring에서 Ajax로 전송된 데이터는 무조건 Map으로 받는다
	 * 	그리고 매개변수에 @ReqyestBody를 반드시 설정해둔더ㅏ
	 * 
	 * 또한 pom.xml에 jackson-databind Dependenty 를 반드시 설정해 둔다 
	 * 
	 */
